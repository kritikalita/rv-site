    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[110] flex items-end justify-center overflow-hidden">
          ...
          >
            {/* 1. STICKY HUD HEADER - Updated to Sky Blue style */}
            <div className="sticky top-0 z-[70] bg-white/90 backdrop-blur-md border-b border-blue-50 px-6 md:px-12 py-4 flex justify-between items-center">
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2 px-3 py-1 bg-blue-50 border border-blue-100 rounded-sm">
              ...
              <button 
                onClick={onClose}
                className="p-2 hover:bg-blue-50 rounded-full transition-colors text-brand-dark"
              >
                <TbX size={24} />
              </button>
            </div>
            ...
            <div className="relative h-[45vh] md:h-[50vh] bg-[#022049] overflow-hidden">
              <img 
                src={storyData.image} 
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-16 py-12 md:py-20 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
              ...
              <div className="lg:col-span-8 space-y-10">
                <p className="text-xl md:text-2xl text-slate-700 leading-relaxed font-medium border-l-4 border-brand-blue pl-6 md:pl-10">
                ...
                <div className="text-slate-600 space-y-6 text-base md:text-lg leading-relaxed">
                  ...
                  {/* UPDATED: Technical Parameters Box to Midnight Gradient */}
                  <div 
                    className="p-6 md:p-10 border border-white/10 rounded-sm shadow-xl"
                    style={{ background: 'linear-gradient(135deg, #022049 0%, #063677 100%)' }}
                  >
                    <h4 className="text-white font-bold mb-8 flex items-center gap-2 text-sm md:text-base tracking-tight">
                       <TbCpu className="text-blue-300" /> ARCHITECTURAL PARAMETERS
                    </h4>
                    <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-6 font-mono text-[11px] md:text-xs">
                      <li className="flex justify-between border-b border-white/10 pb-3">
                        <span className="text-blue-200/50 uppercase tracking-wider">Tolerance Range</span>
                        <span className="font-bold text-blue-300">±0.003mm</span>
                      </li>
                      <li className="flex justify-between border-b border-white/10 pb-3">
                        <span className="text-blue-200/50 uppercase tracking-wider">Base Material</span>
                        <span className="font-bold text-white">Ti-6Al-4V</span>
                      </li>
                      <li className="flex justify-between border-b border-white/10 pb-3">
                        <span className="text-blue-200/50 uppercase tracking-wider">Output Rating</span>
                        <span className="font-bold text-blue-300">Tier-1 Class</span>
                      </li>
                      <li className="flex justify-between border-b border-white/10 pb-3">
                        <span className="text-blue-200/50 uppercase tracking-wider">Verification</span>
                        <span className="font-bold text-white">Nadcap Spec</span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="lg:col-span-4">
                <div className="sticky top-32 space-y-8">
                  {/* UPDATED: Sidebar to Sky Blue Style */}
                  <div className="p-6 md:p-8 border border-blue-100 bg-blue-50/50 rounded-sm">
                    <h4 className="font-mono text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-8 flex items-center gap-2">
                      <TbDatabase className="text-brand-blue" size={14} /> System_Log // RV_2025
                    </h4>
            ...
            {/* 4. MODAL FOOTER - Updated to Signature Gradient */}
            <div 
              className="py-16 px-8 flex flex-col items-center"
              style={{ background: 'linear-gradient(to bottom, #022049, #010816)' }}
            >
               <div className="h-px w-24 bg-brand-blue/30 mb-8" />
               <p className="text-blue-300/40 font-mono text-[9px] tracking-[0.5em] uppercase">
