        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
          ...
          >
            ...
            <div className="p-8 md:p-12">
              ...
              {/* Technical Details Box - UPDATED with Gradient Background */}
              <div className="bg-gradient-to-br from-[#022049] to-[#063677] border border-white/10 p-6 mb-8 font-mono shadow-inner">
                <div className="flex items-center gap-2 mb-4 text-[10px] font-bold text-blue-200/50 uppercase tracking-widest border-b border-white/10 pb-2">
                  <TbDatabase className="text-[#0047AB]" /> Log_Report_082
                </div>
                <ul className="space-y-2">
                  <li className="text-[11px] text-blue-100/70">
                    <span className="text-white font-bold">TIMESTAMP:</span> {new Date().toLocaleTimeString()} IST
                  </li>
                  <li className="text-[11px] text-blue-100/70">
                    <span className="text-white font-bold">DESTINATION:</span> HQ_Transmission_Server
                  </li>
                  <li className="text-[11px] text-blue-100/70">
                    <span className="text-white font-bold">ENCRYPTION:</span> AS9100D_Standard
                  </li>
                </ul>
              </div>
